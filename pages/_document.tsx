...
class MyDocument extends Document {
    render() {
        ...
        const description =
            "Use our Reward Points Calculator to determine the total reward points you'll earn for your upcoming spend. Maximize your rewards and make the most of your purchases.";
        const image = "https://tripplannerai.xyz/_static/thumbnail.png";
        ...
        return (
            <Html lang="en">
                <Head>
                  ...
                  {/* <meta property="og:logo" content="https://tripplannerai.xyz/_static/logo.png"></meta> */}
